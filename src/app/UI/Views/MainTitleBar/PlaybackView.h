...
private:
    ...
    const QIcon icoAutoScrollWhite = QIcon(":svg/icons/auto_scroll_16_filled_white.svg");
    const QIcon icoAutoScrollBlack = QIcon(":svg/icons/auto_scroll_16_filled.svg");
