...
void ClipActions::moveClipBetweenTracks(Clip *clip, Track *fromTrack, Track *toTrack) {
    setName(tr("Move clip between tracks"));
    addAction(MoveClipBetweenTracksAction::build(clip, fromTrack, toTrack));
}